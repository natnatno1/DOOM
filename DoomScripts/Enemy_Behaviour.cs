...
public class Enemy_Behaviour : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Define what happens when the distance between this game object and the player is less than 2, more than 1 and when the Health value is more than 0
        ...
        // Define what happens when the distance between this game object and the player is less than 1, and the Health value is more than 0
        ...
        // Define what happens when the "ShotgunSargeantShootingForward" animation is playing for this gameobject

        if (Anim.GetCurrentAnimatorStateInfo(0).IsName("ShotgunSargeantShootingForward"))
        {
            ...
            if (ShootingCooldown <= 0)
            {
                ...
                // Reset the ShootingCooldown variable to 0.375 (the length of the attack animation)

                ShootingCooldown = 0.375f;
            }
        }
    }
